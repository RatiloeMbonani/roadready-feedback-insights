...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RoadReady Insights" },
      {
        name: "description",
        content:
          "Citizen feedback and sentiment analytics for RoadReady Traffic Services.",
      },
      { name: "author", content: "RoadReady Traffic Services" },
    ...
    <QueryClientProvider client={queryClient}>
      <div className="min-h-screen">
          ...
          <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
            <Link to="/" className="flex items-center gap-3">
              ...
              <span className="font-display text-xl font-bold uppercase tracking-wide">
                RoadReady <span className="text-primary">Insights</span>
              </span>
            </Link>
        ...
        <footer className="border-t border-border/70 py-6 text-center text-xs text-muted-foreground">
          RoadReady Traffic Services · Phase 2 · Sentiment powered by VADER + Hugging Face
        </footer>
      </div>
